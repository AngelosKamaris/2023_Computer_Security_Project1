...
$first_topic=mysql_real_escape_string($first_topic);
$topics_per_page=mysql_real_escape_string($topics_per_page);
...
if (mysql_num_rows($result) > 0) { // topics found
	while($myrow = mysql_fetch_array($result)) {
		...
		$uid=mysql_real_escape_string($uid);
		$cours_id=mysql_real_escape_string($cours_id);
		$myrow[topic_id] =mysql_real_escape_string($myrow[topic_id] );
